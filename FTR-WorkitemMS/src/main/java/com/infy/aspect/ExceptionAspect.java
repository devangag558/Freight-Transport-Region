...
public class ExceptionAspect {
	...
	@ExceptionHandler(WORKITEM_NOT_FOUND.class)
	public ResponseEntity<ErrorMessage> vehicleNotFoundExceptionHandler(WORKITEM_NOT_FOUND e){
	...
	@ExceptionHandler(WORKITEM_VEHICLE_ALLOCATED.class)
	public ResponseEntity<ErrorMessage> vehicleUpdateAlreadyExistsExceptionHandler(WORKITEM_VEHICLE_ALLOCATED e){
		ErrorMessage msg = new ErrorMessage();
		msg.setMessage(e.getMessage());
		msg.setStatusCode(HttpStatus.BAD_REQUEST.value());
		msg.setUrl("/ftr/vehicles");
